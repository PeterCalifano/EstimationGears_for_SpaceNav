function [xhatPost, Spost, Ppost, Pprior, WmWc] = SR_UKF_kernel_SGNexe3(xhat, Scov, i_dyObs, Q, R, params) %# codegen
%% PROTOTYPE
% [xhatPost, Spost, Ppost] = SR_UKF_kernel(xhat, Scov, ymeas, Q, R)
% -------------------------------------------------------------------------------------------------------------
%% DESCRIPTION
% What the function does
% % DEV IN PROGRESS: NOT YET WORKING CORRECTLY
%
...
% -------------------------------------------------------------------------------------------------------------
%% DEPENDENCIES
% All functions and inputs computed in SGC assignment 2 exe 3.
% -------------------------------------------------------------------------------------------------------------
