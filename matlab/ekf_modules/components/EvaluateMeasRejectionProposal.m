function [bProposeRejection, dM2dist] = EvaluateMeasRejectionProposalal(dAllPriorResVector, ...
                                                                            dPyyResCov, ...
                                                                            ui32AllocIndex, ...
                                                                            dMahaDist2MeasThr, ...
                                                                            ui8MeasKind) %#codegen
...
%% SIGNATURE
% [bProposeRejection, dM2dist] EvaluateMeasRejectionProposalal(dAllPriorResVector, ...
%                                                                    dPyyResCov, ...
%                                                                    ui32AllocIndex, ...
%                                                                    dMahaDist2MeasThr, ...
%                                                                    ui8MeasKind)
