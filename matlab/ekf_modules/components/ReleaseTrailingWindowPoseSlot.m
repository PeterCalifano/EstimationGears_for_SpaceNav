function [dStateCovPost, strFilterMutabPost] = ...
        ReleaseTrailingWindowPoseSlot(dStateCovPrior, ...
...
bReleaseTrailingSlot = ...
    strFilterMutabConfig.bIsSlidingWindFull && ...
...
ui32FirstTrailingCovIdx = ...
    ui32FullCovSize + uint32(1) - ui32WindowCovBlockSize;
...
strFilterMutabPost.ui16WindowStateCounter = ...
    strFilterMutabPost.ui16WindowStateCounter - uint16(1);
