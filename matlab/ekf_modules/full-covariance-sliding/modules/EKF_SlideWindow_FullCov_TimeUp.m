...
arguments (Output)
    ...
    strDynParams            {isstruct}
    dFlowSTM                (:,:) {ismatrix,isnumeric}
    dDynMatrix              (:,:) {ismatrix,isnumeric}
    dDynMatrixNext          (:,:) {ismatrix,isnumeric}
    strFilterMutabConfig    {isstruct}
    dIntegrProcessNoiseCovQ       (:,:) {ismatrix,isnumeric}
end
%% SIGNATURE
% [dxStatePrior, ...
% dxStateCovPrior, ...
...
% dDynMatrixNext, ...
% strFilterMutabConfig, ...
% dQprocessNoiseCov] = EKF_SlideWindow_FullCov_TimeUp(dxState, ...
%                                                dxStateCov, ...
%                                                dStateTimetag, ...
%                                                dTargetTimetag, ...
%                                                strDynParams, ...
...
% dDynMatrixNext          (:,:) {ismatrix,isnumeric}
% strFilterMutabConfig    {isstruct}
% dQprocessNoiseCov       (:,:) {ismatrix,isnumeric}
% -------------------------------------------------------------------------------------------------------------
%% CHANGELOG
