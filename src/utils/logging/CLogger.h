/// @file CLogger.h
/// @brief Declares the dependency-free EstimationGears component logger.
...
namespace estimation_gears::logging
{
    /**
    ...
    class CLogger final
    {
      public:
         ...
         * replaced with `EstimationGears_for_SpaceNav`.
      ...
      public:
        ...
        bool setLevelFromEnvironment(
            std::string_view charVariableName = "ESTIMATION_GEARS_LOG_LEVEL");
