classdef testTriangulate3dPointInvDepth_GaussNewton < matlab.unittest.TestCase
    ...
    methods (TestClassSetup)
        ...
        function [testCase] = setup(testCase, dHalfSideSize, dSigmaKpt, ui32RngSeed)
            ...
            [~, testCase.dRefAttitudes_TBfromCAM] = objAttitudeGenerator.pointToTarget("enumConstraintType", "auxiliaryAxis", ...
    ...
    methods(TestMethodSetup)
        ...
        function setupTest(testCase)
            % Set test parameters
            testCase.ui32MaxIter = 10; % ACHTUNG, parameter to swipe
    ...
    methods(Test)
        ...
        function testTriangulation_SingleFeature(testCase)
            ...
            for idF = 0:ui32NumOfFeatures-1 % TODO: update test to store all features!
                ...
                [dFeatPosVec_NavFrame, dFeatPosVec_Ck, dRelPos_CkFromCi_Ci, dDCM_CiFromCk] = ...
                    Triangulate3dPointInvDepth_GaussNewton(dyNormCoordVec, ...
