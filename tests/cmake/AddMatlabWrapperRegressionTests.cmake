function(add_estimation_gears_matlab_wrapper_regression_tests)
  ...
  foreach(_case IN LISTS _matlab_cases)
    ...
    add_test(
      ...
      COMMAND "${_matlab_program}" -batch
        "addpath('${_matlab_test_dir}'); RunEstimationGearsWrapperRegression('${_case}', '${_matlab_toolbox_dir}', '${_matlab_mex_dir}');")
    set_tests_properties(
      ${_test_name}
      PROPERTIES
